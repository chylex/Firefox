...
You can use the included `chylex.sh` script to run the necessary commands for building Firefox and creating an English and Czech installer. Run `./mach clobber` first for a full rebuild.
